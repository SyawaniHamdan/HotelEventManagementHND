    ...
    public partial class EventSchedule : Form
    {
        ...
        private void btnView_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string query = "select CustID,EName,Etype,QuantityDay,Eloc,Chair,Table,PAsystem,Microphone,StartDate,TimeIn from Try where [Month] ='" + cboMonth.Text + "' ";
                com.CommandText = query;

                listBox1.Items.Add("\t\t\t\t\t\t\t\t\t MONTHLY EVENT SCHEDULE         ");
                listBox1.Items.Add("");
