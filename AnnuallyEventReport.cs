...
namespace FYP_Event
{
    public partial class AnnuallyEventReport : Form
    {
        ...
        private void btnView_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string query = "select CustID,EName,Etype,QuantityDay,Eloc,StartDate,TimeIn from Try where [Year] ='" + txtYear.Text + "' ";
                com.CommandText = query;

                listBox1.Items.Add("\t\t\t\t\t\t\t       ANNUALLY REPORT         ");
                listBox1.Items.Add("");
