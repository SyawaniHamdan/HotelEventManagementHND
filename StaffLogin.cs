...
namespace FYP_Event
{
    public partial class StaffLogin : Form
    {
        ...
        private void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            com.CommandText = "select * from Staff where Username = '"+ txtUserName.Text +"' and Password = '"+ txtPassWord.Text +"'";
            ...
            while(read.Read())
            {
                ...
                if (count == 1)
                {
                    MessageBox.Show("Welcome to Staff Main Menu", "SUCCESS", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    ActiveForm.Hide();
